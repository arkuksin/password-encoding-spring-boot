...
@Component
public class BcCryptCalculator {

    private static final String TEST_PASSWORD = "my password";
    private static final int GOAL_MILLISECONDS_PER_PASSWORD = 500;
    private static final int MIN_STRENGTH = 4;
    private static final int MAX_STRENGTH = 31;


    /**
     * Calculates the strength (a.k.a. log rounds) for the BCrypt Algorithm, so that password encoding takes about 500ms.
     ...
     * When the the duration takes more than 500ms, it is compared to previous one and the method returns the strength, tha ios closer
     * to 500ms.
     */
    ...
    /**
     * return true, if previousDuration is closer to goal than currentDuration, false otherwise.
     */
