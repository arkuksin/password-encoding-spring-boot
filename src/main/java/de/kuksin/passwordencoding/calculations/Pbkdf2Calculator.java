...
public class Pbkdf2Calculator {
    ...
    /**
     * Find the number of Iteration for the {@link Pbkdf2PasswordEncoder} to get the duration of password encoding
     * close to 500ms. The Calculation does not use any secret (pepper) and applies hash algorithm SHA256.
     */
